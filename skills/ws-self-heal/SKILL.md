...
Run repo quality / self-healing. Activate when the user says: "healthcheck repos",
"run the fix loop", "self-heal", "repo quality", "what's lacking in my repos",
"fix repo gaps", or asks to converge a service to green.
